		...
		for (cy=0;cy<size;cy++){
			...
			for (cx=0;cx<size;cx++){
				...
				while (a<40) {
					...
					/*Se indica que se abrirá y se escribirá en un archivo con el nombre de la cadena de caracteres indicada por snprintf, donde se imprimirán las temperaturas calculadas*/
