...
#include<math.h>
	...
	/*Instruccion que nos permite ralizar un ciclo con opciones previemente especificadas en el programa, en este caso se hará el ciclo de volver a preguntar al usuario si quiere la opcion uno o dos al terminar las instrucciones de alguno de esas dos instrucciones previamente*/
	...
	case 2:
		...
		printf("z= %lf \n", Z);
	/*Indicamos el termino del el primer ciclo, y el programa sigue al siguiente*/
		break;
	/*Es la instruccion para realizar una accion en caso que ninguno de los casos anteriores se cumplieron*/
	default:
		/*Se indica al usuario que las opciones que entro son invalidas*/
		printf("Opcion invalida\n");
		
		break;
	}
	/*Imprimimos a la patnalla que el usuario puede eolvr a entrar una accion y usarlo de nuevo*/
	printf("Escribe 1 si quieres convertir temperatura, escribe 2 si quieres convertir coordenadas o escribe 3 si queres salir del programa:\n");
	scanf("%i", &opcion);	
